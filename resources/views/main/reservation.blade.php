...
@section('content')
    <div class="fh5co-parallax" style="background-image: url(images/banner/banner4.jpg); height:300px;" data-stellar-background-ratio="0.5" style="height:300px;">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="form-group">
                        <select class="form-control" name="country">
                            ...
                            <option value="Congo_democratique">Congo-Kinshasa</option>
