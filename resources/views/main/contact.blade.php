...
@section('content')
    <div class="fh5co-parallax" style="background-image: url(images/logo/bann.jpg);font-size: small; height:300px;" data-stellar-background-ratio="0.5" style="height:300px;">
    ...
    <div class="col-md-8 col-md-offset-2" style="padding-top:3em">
        ...
        <ul class="contact-info">
            ...
            <li><i class="ti-envelope"></i><a href="mailto:info@pyramide-hotel.com">info@pyramide-hotel.com</a></li>
            <li><i class="ti-home"></i><a href="www.pyramide-hotel.com">www.pyramide-hotel.com</a></li>
        </ul>
    </div>
