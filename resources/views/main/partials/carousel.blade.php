<aside id="fh5co-hero" class="js-fullheight">
    <div class="flexslider js-fullheight">
        <ul class="slides">
        <li style="background-image: url({{ asset("images/chambres/presidentielle.jpg") }});">
        ...
        <li style="background-image: url({{ asset("images/chambres/luxe.jpg") }});">
            <div class="overlay-gradient"></div>
            <div class="container">
                <div class="col-md-12 col-md-offset-0 text-center slider-text">
                    <div class="slider-text-inner js-fullheight">
        ...
        <li style="background-image: url({{ asset("images/chambres/junior.jpg") }});">
            <div class="overlay-gradient"></div>
            <div class="container">
                <div class="col-md-12 col-md-offset-0 text-center slider-text">
                    <div class="slider-text-inner js-fullheight">
        ...
        <li style="background-image: url({{ asset("images/chambres/prestige.jpg") }});">
            <div class="overlay-gradient"></div>
            <div class="container">
                <div class="col-md-12 col-md-offset-0 text-center slider-text">
                    <div class="slider-text-inner js-fullheight">
        ...
        <li style="background-image: url({{ asset("images/chambres/standard.jpg") }});">
            <div class="overlay-gradient"></div>
            <div class="container">
                <div class="col-md-12 col-md-offset-0 text-center slider-text">
                    <div class="slider-text-inner js-fullheight">
